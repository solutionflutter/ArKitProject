...
class ArMesurementScreen extends StatefulWidget {
  const ArMesurementScreen({Key? key}) : super(key: key);

  @override
  _ArMesurementScreenState createState() => _ArMesurementScreenState();
}

class _ArMesurementScreenState extends State<ArMesurementScreen> {
